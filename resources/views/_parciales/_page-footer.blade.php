<footer id="footer">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-10 col-md-offset-1">
                <ul class="opciones">
                    <li><h5><i class="fa fa-info-circle pr-sm"></i>¿Cómo citar esta página?</h5></li>
                </ul>

                <p><b>Web Ficoflora Venezuela.</b>  2015. <b>Catálogo de la Ficoflora de Venezuela.</b>
                    ...
                    Consultado el {{Carbon\Carbon::now()->day}} de {{Carbon\Carbon::now()->format('M.')}} de {{Carbon\Carbon::now()->year}},
    ...
    <div class="footer-copyright">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <p>Proyecto Ficoflora Venezuela © 2015</p>
                </div>
                {{--<div class="col-md-4">--}}
                    {{--<nav id="sub-menu">--}}
                        {{--<ul>--}}
