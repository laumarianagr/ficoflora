                ...
                <div class="widget-summary">
                    ...
                    <div class="widget-summary-col">
                        ...
                        <div class="summary mb-sm">
                            <div class="info">
                                @yield('taxo-tipo'): <em><b class="amount">@yield('taxo-nombre')</b></em>@yield('taxo-autor')
                            </div>
                        </div>
        ...
        <div class="panel">
            <div class="panel-body">
                ...
                <div class="col-md-4 nueva-busqueda">
                       <a class="dp-in-b" href="{{route('buscar.taxonomia.index')}}"><i class="fa fa-search"></i>Nueva búsqueda</a>
                    </div>
                </div>
