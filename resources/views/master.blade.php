...
<div class="p-container">
    ...
    <div class="p-body">
        ...
        <div class="p-content w-940" role="main">

            <div class="content-body row">
                @yield('content')
            </div>

            {{-- bloque de enlaces a listados--}}
            @include('_parciales._page-listados')
...
<div id="p1" style="visibility:hidden; z-index: 100;">
    <b>Web Ficoflora Venezuela.</b>  {{Carbon\Carbon::now()->year}}. <b>Catálogo digital de la Ficoflora de Venezuela.</b>Publicación electrónica. Universidad Central de Venezuela, Caracas.
    Editores: Santiago Gómez, Yusneyi Carballo Barrera, Mayra García & Nelson Gil. Consultado el {{Carbon\Carbon::now()->day}} de {{$mes}} de {{Carbon\Carbon::now()->year}},
