...
@section('ubicacion-tipo'){{"Lugar"}}@stop
...
@section('ubicacion-nombre1')
            <!-- incluye llamada al mapa -->
            {{$ubicacion['lugar']}}
            <a id="modal-lugar2" href="#modal-mapa" class="modal-basic modal-with-zoom-anim"><i class="fa fa-map-marker"></i></a>
@stop

@section('ubicacion-nombre2'){{$ubicacion['lugar']}}@stop
