    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading  p-xs">
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Catálogos registrados por el usuario</h5>
            </header>
                ...
                <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                    ...
                    @foreach($catalogos as $catalogo)
                        ...
                        <tr>
                            ...
                            <td class="" data-type="text" > {{$catalogo->autores}}</td>
                            <td class="" data-type="text" > {{$catalogo->titulo}}</td>

                            <td class="acciones-row">
                                <a href="{{route ('catalogo.editar' ,$catalogo->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
...
@section('script_section')
    ...
    <script>
        ...
        var taxo_tabla='referencias/catalogos';
