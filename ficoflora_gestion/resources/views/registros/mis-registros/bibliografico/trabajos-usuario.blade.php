...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Trabajos académicos</span></a></li>
@stop
    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading p-xs">
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Trabajos académicos registrados por el usuario</h5>
            </header>
            <div class="panel-body">

                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="mt-xs mb-xs">Número de trabajos: <b>{{$total}}</b></h5>
                    </div>
                    <div class="col-sm-4 ">
                ...
                <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                    ...
                    @foreach($trabajos as $trabajo)
                        ...
                        <tr>
                            <td></td>
                            <td class="" data-type="text" >{{$trabajo->id}}</td>
                            <td class="" data-type="text" >({{$trabajo->cita}}, {{$trabajo->fecha}}{{$trabajo->letra}})</td>
                            <td class="" data-type="text" > {{$trabajo->autores}}</td>
                            <td class="" data-type="text" > {{$trabajo->titulo}}</td>

                            <td class="acciones-row">
                                <a href="{{route ('trabajo.mostrar' ,$trabajo->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
                                ...
                                <a href="{{route ('trabajo.mostrar' ,$trabajo->id )}}" data-toggle="tooltip" title="Información" ><i class="fa fa-info-circle"></i></a>
                            </td>
