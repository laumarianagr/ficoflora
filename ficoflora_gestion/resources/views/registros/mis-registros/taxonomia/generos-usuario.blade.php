    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading  p-xs">
                ...
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Géneros registrados por el usuario</h5>
            </header>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="mt-xs mb-xs">Número de géneros: <b>{{$total}}</b></h5>
                    </div>
                    <div class="col-sm-4 ">
                        <a class="btn btn-default pull-right" href="{{route('genero.crear')}}" id="crear-row" data-toggle="tooltip" title="Nuevo" ><i class="fa fa-plus text-primary"></i> Nuevo género</a>
                    </div>
                </div>
                ...
                <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th class="perfil-col">Nombre del Género</th>
                    ...
                    @foreach($generos as $genero)
                        ...
                        <tr>
                            <td></td>
                            <td class="" data-type="text" >{{$genero->id}}</td>
                            <td class="" data-type="text" ><a href="{{route ('genero.mostrar' ,$genero->id )}}">{{$genero->nombre}}</a></td>

                            <td class="acciones-row">
                                <a href="{{route ('genero.editar' ,$genero->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
                                ...
                                <a href="{{url ('/generos',$genero->id )}}" data-toggle="tooltip" title="Información" ><i class="fa fa-info-circle"></i></a>
                            </td>
