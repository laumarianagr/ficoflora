    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading  p-xs">
                ...
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Epítetos Varietales registrados por el usuario</h5>
            </header>
                    ...
                    @foreach($varietales as $varietal)
                        ...
                        <tr>
                            ...
                            <td class="acciones-row">
                                <a href="{{route ('varietal.editar' ,$varietal->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
