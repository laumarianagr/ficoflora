...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Epítetos de Forma</span></a></li>
@stop
    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading p-xs">
                ...
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Epítetos de Forma registrados por el usuario</h5>
            </header>
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="mt-xs mb-xs">Número de epítetos de forma: <b>{{$total}}</b></h5>
                    </div>
                    <div class="col-sm-4 ">
                ...
                <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th class="perfil-col">Nombre del Epiteto de Forma</th>
                    ...
                    @foreach($formas as $forma)
                        ...
                        <tr>
                            ...
                            <td class="acciones-row">
                                <a href="{{route ('forma.editar' ,$forma->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
