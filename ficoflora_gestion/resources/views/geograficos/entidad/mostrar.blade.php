...
@section('titulo-seccion')
    Información de la Entidad Federal
@stop

@section('breadcrumbs')
    <li><a href="{{route('registros.index')}}"><span>Registros</span></a></li>
    <li><a href="#"><span>Entidades</span></a></li>
                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    <span class="muted">entidad federal: </span><strong class="amount">{{$ubicacion['entidad']}}</strong>
                            ...
                            @if($ubicacion['creador_id'] == $usuario->id || $usuario->perfil_id <=2)
                                ...
                                <div class="summary-footer">
                                    <a href="{{route('entidad.editar', [$ubicacion['entidad_id']])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                </div>
                            @endif
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class=" mb-md tabla-mostrar-datos ">
                        <h4 class="">Localidades ubicadas en la entidad federal: </h4>
                    </div>
                    <h6 class="mt-md ">Número de localidades: <b>{{$total_localidades}}</b></h6>
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="th-dataTable ">Nombre de la Localidad</th>
                        ...
                        @foreach($localidades as $localidad)
                            <tr>
                                ...
                                <td class="perfil">
                                        <a href="{{route('localidad.mostrar', [$localidad['id']])}}">{{$localidad['nombre']}}</a>
                                </td>

                                <td>
                                    <a class="action not-active" href="{{route('localidad.mostrar', [$localidad['id']])}}">{{$localidad['especies']}} </a>
                                </td>
        ...
        <div class="col-xs-12">
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class=" mb-md tabla-mostrar-datos ">
                        <h4 class="">Especies reportadas en la Entidad Federal: </h4>
                    </div>
