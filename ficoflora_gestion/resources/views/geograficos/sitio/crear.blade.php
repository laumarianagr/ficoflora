...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open([ 'route' => ['sitio.guardar'],  'id'=>'jv_sitio', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">


                <h2 class="panel-title">Nuevo Sitio</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('sitio', null, ['id'=>'sitio', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <div class="col-xs-12 col-sm-12 pl-none">
                                {!! Form::select('lugar', $lista_lugares, null, ['id'=> 'lugar','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
                        </div>
                    </div>
