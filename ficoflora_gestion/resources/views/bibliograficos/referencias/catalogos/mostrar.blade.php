                ...
                <div class="panel-body">
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                <div class="info">
                                    <strong class="amount">{{$catalogo->autores}}, {{$catalogo->fecha}}{{$catalogo->letra}}</strong>
                                </div>
                            ...
                            @if($usuario->perfil_id <=3)
                                <div class="summary-footer">
                                    <a class="" href="{{route('usuario.catalogos')}}"><i class="fa fa-user pr-xs"></i>Mis catálogos</a>

                                @if($catalogo->creador_id == $usuario->id || $usuario->perfil_id <=2)
            ...
            <section class="panel tabla-mostrar-datos ">
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        <tr><td><h5><b>Cita:</b></h5> {{$catalogo->cita}}, {{$catalogo->fecha}}{{$catalogo->letra}}</td></tr>
                        <tr><td><h5><b>Autores:</b></h5> {{$catalogo->autores}}</td></tr>
                        <tr><td><h5><b>Año:</b></h5> {{$catalogo->fecha}}</td></tr>
                        <tr><td><h5><b>Título:</b></h5> {{$catalogo->titulo}}</td></tr>

                        {{-- campos que aplican a un catálogo incluido en revista --}}

                        @if($catalogo->nombre != null)
                            <tr><td><h5><b>Nombre:</b></h5> {{$catalogo->nombre}}</td></tr>
                        @endif
                        @if($catalogo->volumen != null)
                            <tr><td><h5><b>Volumen:</b></h5> {{$catalogo->volumen}}</td></tr>
                        @endif
                        @if($catalogo->numero != null)
                            <tr><td><h5><b>Número:</b></h5> {{$catalogo->numero}}</td></tr>
                        @endif


                        {{-- campos que aplican a un catálogo incluido en libro --}}
                        @if($catalogo->editor_editorial != null)
                            <tr><td><h5><b>Editor y Editorial:</b></h5> {{$catalogo->editor_editorial}}</td></tr>
                        @endif
                        @if($catalogo->edicion != null)
                            <tr><td><h5><b>Edición:</b></h5> {{$catalogo->edicion}}</td></tr>
                        @endif
                        @if($catalogo->lugar != null)
                            <tr><td><h5><b>Lugar:</b></h5> {{$catalogo->lugar}}</td></tr>
                        @endif


                        <tr><td><h5><b>Páginas:</b></h5> {{$catalogo->paginas}}</td></tr>
                        <tr><td><h5><b>ISBN:</b></h5> {{$catalogo->isbn}}</td></tr>
                        <tr><td><h5><b>Archivo:</b></h5> {{$catalogo->archivo}}</td></tr>
                        <tr><td><h5><b>Comentarios:</b></h5> {{$catalogo->comentarios}}</td></tr>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 ">
                            @if($usuario->perfil_id <=3)
                                <a class="agregar modal-with-form btn btn-default pull-right" href="#modal-agregar-registro"  id="crear-row" data-toggle="tooltip" title="Crear" > <i class="fa fa-plus text-primary"></i> Crear Registro</a>
                            ...
                            <tr>
                                ...
                                <td class="perfil">
                                    <a href="{{route('reporte.mostrar', [$especie['id']])}}">
                                        ({{$catalogo->cita}}, {{$catalogo->fecha}}{{$catalogo->letra}}) | <em>{{$especie['nombre']}}</em> <span class="autores">{{$especie['autor']}}</span>
                                    </a>
                                </td>
...
@section('script_section')
    ...
    <script>
        var referencia = <?php echo $catalogo->id ?>;
...
//
        ...
        var action = $(this).attr('action');
            ...
            $('#jv_especie_select').append($("<input>").attr({"type":"hidden","name":"tipo"}).val('L'));
