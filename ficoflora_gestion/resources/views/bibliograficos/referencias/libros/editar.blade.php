...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Libro</span></a></li>
@stop
                ...
                <div class="row" >
                    ...
                    {{--<div class="col-xs-12 col-md-8 col-lg-6" >--}}
                        ...
                        <section class="panel form-wizard mb-xs" id="ref_libro">
                            ...
                            {!! Form::open(['method'=> 'PATCH', 'route' => ['libro.actualizar', $libro->id], 'id'=>'referencia_libro', 'class' => 'form form-bordered form_ref']) !!}
                            ...
                            <div class="panel-body">
                                <div class="wizard-progress">
                                    ...
                                    <ul class="wizard-steps">
                                        ...
                                        <li>
                                            <a href="#libro_paso_4" data-toggle="tab"><span>4</span>Adicional</a>
                                        </li>
                                        <li>
                                            <a href="#libro_paso_5" data-toggle="tab"><span>5</span>Complentaria</a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="libro_paso_1" class="row tab-pane active">
                                        ...
                                        <div class="col-sm-12 form-group">
                                            ...
                                            {!! Form::text('autores', $libro->autores, [
                                        ...
                                        <div class="col-sm-12 form-group ">
                                            ...
                                            {!! Form::select('fecha', $fecha, $libro->fecha, ['id'=> 'fecha_libro', 'class' => 'form-control select ', 'style'=>'width: 100%']) !!}
                                        ...
                                        <div class="col-sm-12 form-group">
                                            ...
                                            {!! Form::text('cita', $libro->cita.', '.$libro->fecha.$libro->letra, ['id'=> 'cita_libro', 'class' => 'form-control cita']) !!}
                                        </div>
                                    ...
                                    <div id="libro_paso_2" class="row tab-pane">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            {!! Form::textarea('titulo', $libro->titulo, ['class' => 'form-control tinymce', 'id'=>'titulo_libro' ]) !!}
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            {!! Form::text('edicion', $libro->edicion, ['class' => 'form-control preview', 'id' => 'edicion_libro']) !!}
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            {!! Form::text('editorial', $libro->editorial, ['class' => 'form-control preview', 'id' => 'editorial_libro']) !!}
                                        </div>

                                        {{--input LUGAR libro--}}
                                        <div class="col-xs-12 form-group">
                                            <label class=" control-label" for="lugar_libro">Lugar <span class="required">*</span></label>
                                            {!! Form::text('lugar', $libro->lugar, ['class' => 'form-control preview', 'id' => 'lugar_libro']) !!}
                                        </div>

                                        {{--input PAGINAS libro--}}
                                        <div class=" col-xs-12 form-group">
                                            <label class=" control-label" for="paginas_libro">Total de páginas <span class="required">*</span></label>
                                            {!! Form::text('paginas', $libro->paginas, ['class' => 'form-control preview', 'id' => 'paginas_libro', 'type'=>'number']) !!}
                                        </div>
                                    ...
                                    <div id="libro_paso_3" class="row tab-pane">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            <label class=" control-label" for="capitulo_libro">Título (Capitulo/Sección)</label>
                                            {!! Form::textarea('capitulo', $libro->capitulo, ['class' => 'form-control tinymce', 'id'=>'capitulo_libro' ]) !!}
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            {!! Form::text('editor', $libro->editor, ['class' => 'form-control preview', 'id' => 'editor_libro']) !!}
                                        </div>

                                        {{--input INTERVALO PAGINAS libro--}}
                                        <div class="col-xs-12 form-group">
                                            <label class=" control-label" for="intervalo_libro">Intervalo de páginas</label>

                                            <div class="input-group mb-md">
                                                {!! Form::text('intervalo_1', $libro->intervalo_1, ['class' => 'form-control preview', 'id' => 'intervalo_1_libro']) !!}
                                                <span class="input-group-addon">
                                        <i class="">-</i>
                                    </span>
                                                {!! Form::text('intervalo_2', $libro->intervalo_2, ['class' => 'form-control preview', 'id' => 'intervalo_2_libro']) !!}
                                    ...
                                    <div id="libro_paso_4" class="row tab-pane">
                                        ...
                                        <div class="col-xs-12 form-group">
                                            ...
                                            {!! Form::text('isbn', $libro->isbn, ['class' => 'form-control preview', 'id' => 'isbn_libro']) !!}
                                        </div>

                                        {{--input ISSN libro--}}
                                        <div class="col-xs-12 form-group">
                                            <label class=" control-label" for="isbn_libro">ISSN</label>
                                            {!! Form::text('issn', $libro->issn, ['class' => 'form-control preview', 'id' => 'issn_libro']) !!}
                                        </div>

                                        {{--input DOI libro--}}
                                        <div class="col-xs-12 form-group">
                                            <label class=" control-label" for="doi_libro">DOI</label>
                                            {!! Form::text('doi', $libro->doi, ['class' => 'form-control preview', 'id' => 'doi_libro']) !!}
                                        </div>
