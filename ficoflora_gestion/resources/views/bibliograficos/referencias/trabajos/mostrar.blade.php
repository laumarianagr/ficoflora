...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Trabajo Académico</span></a></li>
                ...
                <div class="panel-body">
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                <div class="info">
                                    <strong class="amount">{{$trabajo->autores}}, {{$trabajo->fecha}}{{$trabajo->letra}}</strong>
                                </div>
                            ...
                            @if($usuario->perfil_id <=3)
                                ...
                                <a class="" href="{{route('usuario.trabajos')}}"><i class="fa fa-user pr-xs"></i>Mis trabajos</a>

                                @if($trabajo->creador_id == $usuario->id || $usuario->perfil_id <=2)

                                | <a href="{{route('trabajo.editar', [$trabajo->id])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                    @endif
            ...
            <section class="panel tabla-mostrar-datos ">
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        <tr><td><h5><b>Trabajo:</b></h5> {{$trabajo->tipo}}</td></tr>

                        <tr><td><h5><b>Cita:</b></h5> {{$trabajo->cita}}, {{$trabajo->fecha}}{{$trabajo->letra}}</td></tr>
                        <tr><td><h5><b>Autores:</b></h5> {{$trabajo->autores}}</td></tr>
                        <tr><td><h5><b>Año:</b></h5> {{$trabajo->fecha}}</td></tr>

                        <tr><td><h5><b>Título:</b></h5> {{$trabajo->titulo}}</td></tr>
                        <tr><td><h5><b>Institución:</b></h5> {{$trabajo->institucion}}</td></tr>
                        <tr><td><h5><b>Lugar:</b></h5> {{$trabajo->lugar}}</td></tr>
                        <tr><td><h5><b>Páginas:</b></h5> {{$trabajo->paginas}}</td></tr>

                        <tr><td><h5><b>Enlace:</b></h5> {{$trabajo->archivo}}</td></tr>
                        <tr><td><h5><b>Archivo:</b></h5> {{$trabajo->archivo}}</td></tr>
                        <tr><td><h5><b>Comentarios:</b></h5> {{$trabajo->comentarios}}</td></tr>
                            ...
                            <tr>
                                ...
                                <td class="perfil">
                                    <a href="{{route('reporte.mostrar', [$especie['id']])}}">
                                        ({{$trabajo->cita}}, {{$trabajo->fecha}}{{$trabajo->letra}}) | <em>{{$especie['nombre']}}</em> <span class="autores">{{$especie['autor']}}</span>
                                    </a>
                                </td>
...
@section('script_section')
    ...
    <script>
        var referencia = <?php echo $trabajo->id ?>;
...
//
            ...
            $('#jv_especie_select').append($("<input>").attr({"type":"hidden","name":"tipo"}).val('T'));
