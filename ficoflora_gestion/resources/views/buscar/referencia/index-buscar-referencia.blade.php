...
@section('content')
    ...
    <div id="buscar-especie" class= "pb-xlg">
        ...
        <div class="row  mb-md">
            ...
            <div class="col-xs-12 ">
                <h3 class="text-dark mb-lg">Catálogo</h3>
            </div>
            ...
            <div class="col-xs-12 ">
                ...
                <section class="panel panel-featured-left panel-featured-primary">
                    <div class="panel-body">
                        ...
                        <label class="control-label" for="autor">Autor</label>
                        {!! Form::text('autor', null, ['id'=>'autor_catalogo', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
            ...
            <div class="col-xs-12  ">
                ...
                <section class="panel panel-featured-left panel-featured-primary">
                    <div class="panel-body">
                        ...
                        <label class="control-label" for="titulo">Título</label>
                        {!! Form::text('titulo', null, ['id'=>'titulo_catalogo', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
        ...
        <div class="row  mb-md">
            ...
            <div class="col-xs-12 ">
                <h3 class="text-dark mb-lg">Sitio Web</h3>
            </div>
            ...
            <div class="col-xs-12 ">
                ...
                <section class="panel panel-featured-left panel-featured-primary">
                    <div class="panel-body">
                        ...
                        <label class="control-label" for="autor">Autor</label>
                        {!! Form::text('autor', null, ['id'=>'autor_enlace', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
            ...
            <div class="col-xs-12  ">
                ...
                <section class="panel panel-featured-left panel-featured-primary">
                    <div class="panel-body">
                        ...
                        <label class="control-label" for="titulo">Nombre del Sitio Web</label>
                        {!! Form::text('titulo', null, ['id'=>'titulo_enlace', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
