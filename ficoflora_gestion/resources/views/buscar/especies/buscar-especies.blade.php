...
@section('content')
    ...
    <div id="buscar-especie" class= "pb-xlg">
        ...
        <div class="row">
            <div class="col-xs-12">
                <h2 class="text-dark mb-xlg"><i class="fa fa-search pr-md"></i>Buscar Especie, Sinonimia, Autoridad, Epíteto o Subespecie</h2>
            </div>
            ...
            <div class="col-xs-3 ">
                <section class="panel panel-featured-left panel-featured-primary">
                    <div class="panel-body">
                        ...
                        {!! Form::text('subespecie', null, ['id'=>'subespecie', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
