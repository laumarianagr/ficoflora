...
@section('breadcrumbs')
    ...
    <li><a href=""><span>Enviados</span></a></li>
@stop
    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading bg-dark p-xs">
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Reportes enviados por el usuario</h5>
            </header>
            <div class="panel-body">

                <a href="{{route('temporal.crear')}}" id="crear-row" data-toggle="tooltip" title="Nuevo" ><i class="fa fa-plus-circle"></i> Enviar nuevo Reporte</a>
