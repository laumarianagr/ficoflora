...
<div id="modal-agregar-sinonimia-ubicacion" class="modal-block  mfp-hide  zoom-anim-dialog">
    <section class="panel">
        ...
        {!! Form::open(['rout' => 'reporte.agregar.sin.ubi',  'id'=>'jv_sinonimia_ubicacion', 'class' => 'form  form-bordered']) !!}

        <div class="panel-body">

            <div class="col-sm-12 form-group">
                <label class=" control-label" for="sinonimia_select">Sinonimia <span class="required">*</span></label>
                {!! Form::select('sinonimia', $sinonimias, null, ['id'=>'sinonimia_select', 'class' => 'form-control select grupo_necesario', 'style'=>'width: 100%' ]) !!}
            </div>

            <div class="col-sm-12 form-group">
                <label class=" control-label" for="entidad">Entidad Federal<span class="required">*</span></label>
                {!! Form::select('entidad', $entidades, null, ['id'=>'entidad_select', 'class' => 'form-control select grupo_necesario', 'style'=>'width: 100%' ]) !!}
            </div>

            <div class="col-sm-12 form-group">
                <label class=" control-label" for="localidad">Localidad <span class="required">*</span></label>
                {!! Form::select('localidad', [], null, ['id'=>'localidad_select', 'class' => 'form-control select', 'style'=>'width: 100%' ]) !!}
            </div>

            <div class="col-sm-12 form-group">
                <label class=" control-label" for="lugares">Lugar <span class="required">*</span></label>
                {!! Form::select('lugar', [], null, ['id'=>'lugar_select', 'class' => 'form-control select', 'style'=>'width: 100%' ]) !!}
            </div>

            <div class="col-sm-12 form-group">
                <label class=" control-label" for="sitios">Sitio <span class="required">*</span></label>
                {!! Form::select('sitio', [], null, ['id'=>'sitio_select', 'class' => 'form-control select', 'style'=>'width: 100%' ]) !!}
            </div>
