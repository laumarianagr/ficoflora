...
@section('titulo-seccion')
    Estadísticas de los Enlaces a Sitios Web
@stop
...
@section('breadcrumbs')
    ...
    <li><a ><span>Sitios Web</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Sitios Web registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Sitios Web con más registros</h4>

            <div id="enlaces-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading p-xs">
                    ...
                    <h5 class="name pl-md">Sitios Web registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($enlaces as $enlace)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('enlace.mostrar',$enlace['id'] )}}">({{$enlace['cita']}})</a></td>
                                <td class="perfil">{{$enlace['autores']}}</td>
                                <td class="perfil">{!!html_entity_decode($enlace['nombre'])!!}</td>
                                <td class="perfil">{{$enlace['fecha']}}</td>
                                <td class="acciones-row">{{$enlace['registros']}}</td>
                            </tr>
...
@section('script_section')
    ...
    <script>
        ...
        var enlaces =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#enlaces-chart',
            data: {
                json:
                        enlaces
                ,
