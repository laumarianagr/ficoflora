...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Libros registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Libros con más registros</h4>

            <div id="libros-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading p-xs">
                    ...
                    <h5 class="name pl-md"> Libros registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($libros as $libro)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('libro.mostrar',$libro['id'] )}}">({{$libro['cita']}})</a></td>
                                <td class="perfil">{{$libro['autores']}}</td>
                                <td class="perfil">{!!html_entity_decode($libro['titulo'])!!}</td>
                                <td class="perfil">{{$libro['fecha']}}</td>
                                <td class="acciones-row">{{$libro['registros']}}</td>
                            </tr>
...
@section('script_section')
    ...
    <script>
        ...
        var libros =<?php echo json_encode($mas_usados); ?>;
