...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Catálogos registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Catálogos con más registros</h4>

            <div id="catalogos-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading p-xs">
                    ...
                    <h5 class="name pl-md">Catálogos registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($catalogos as $catalogo)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('catalogo.mostrar',$catalogo['id'] )}}">({{$catalogo['cita']}})</a></td>
                                <td class="perfil">{{$catalogo['autores']}}</td>
                                <td class="perfil">{!!html_entity_decode($catalogo['titulo'])!!}</td>
                                <td class="perfil">{{$catalogo['fecha']}}</td>
                                <td class="acciones-row">{{$catalogo['registros']}}</td>
                            </tr>
...
@section('script_section')
    ...
    <script>
        ...
        var catalogos =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#catalogos-chart',
            data: {
                json:
                        catalogos
                ,
