...
@section('titulo-seccion')
    Estadísticas de los Localidades
@stop
...
@section('breadcrumbs')
    ...
    <li><a ><span>Localidades</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Localidades registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Localidades con más reportes de especies</h4>

            <div id="localidades-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Localidades registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($localidades as $localidad)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('localidad.mostrar',$localidad['id'] )}}">{{$localidad['nombre']}}</a></td>
                                <td class="acciones-row">{{$localidad['especies']}}</td>
                            </tr>
...
@section('script_section')
    ...
    <script>
        ...
        var localidades =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#localidades-chart',
            data: {
                json:
                        localidades
                ,
                ...
                type : 'bar',
                names: {
                    especies: 'Número de especies en la localidad',
                },
