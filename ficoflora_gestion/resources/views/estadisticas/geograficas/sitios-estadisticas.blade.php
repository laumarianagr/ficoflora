...
@section('breadcrumbs')
    ...
    <li><a href="{{route('estadisticas.geograficas')}}" ><span>Geográficas</span></a></li><li><a ><span>Sitios</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                </div><h3 class="text-dark mt-sm mb-none">Sitios registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            <h4 class="text-dark mt-none mb-lg">Sitios con  más reportes de especies</h4>

            <div id="sitios-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Sitios registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($sitios as $sitio)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('sitio.mostrar',$sitio['id'] )}}">{{$sitio['nombre']}}</a></td>
                                <td class="acciones-row">{{$sitio['especies']}}</td>
                            </tr>
...
@section('script_section')
    ...
    <script>
        ...
        var sitios =<?php echo json_encode($mas_usados); ?>;
        ...
        var chart = c3.generate({
            ...
            data: {
                ...
                type : 'bar',
                names: {
                    especies: 'Número de especies en la sitio',
                },
