...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Subclases registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Subclases con más órdenes</h4>

            <div id="subclases-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading bg-dark p-xs">
                    ...
                    <h5 class="name pl-md"> Subclases registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="numeros">#</th>
                            <th class="perfil-col">Nombre de la Subclases</th>
                        ...
                        @foreach($subclases as $subclase)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('subclase.mostrar',$subclase['id'] )}}">{{$subclase['nombre']}}</a></td>
                                <td class="acciones-row">{{$subclase['ordenes']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var subclases =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#subclases-chart',
            data: {
                json:
                        subclases
                ,
                ...
                type : 'bar',
                names: {
                    ordenes: 'Número de órdenes reportados',
                },
