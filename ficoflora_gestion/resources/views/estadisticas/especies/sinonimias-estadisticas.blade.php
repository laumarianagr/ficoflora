...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Sinonimias registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Sinonimia asociadas a más especies</h4>

            <div id="sinonimias-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Sinonimia registradas</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="numeros">#</th>
                            <th class="perfil-col">Nombre de la Sinonimia</th>
                        ...
                        @foreach($sinonimias as $sinonimia)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('sinonimia.mostrar',$sinonimia['id'] )}}"><em>{{$sinonimia['nombre']}}</em> {{$sinonimia['autor']}}</a></td>
                                <td class="acciones-row">{{$sinonimia['especies']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var sinonimias =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#sinonimias-chart',
            data: {
                json:
                        sinonimias
                ,
