...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Registros del catálogo</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Especies con más registros</h4>

            <div id="especies-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Cantidad de especies por registrso </h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="numeros">#</th>
                            <th class="perfil-col">Nombre de la Especie</th>
                        ...
                        @foreach($especies as $especie)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('especie.mostrar',$especie['id'] )}}"><em>{{$especie['nombre']}}</em> {{$especie['autor']}}</a></td>
                                <td class="acciones-row">{{$especie['registros']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var especies =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#especies-chart',
            data: {
                json:
                        especies
                ,
                ...
                type : 'bar',
                names: {
                    registros: 'Total de registros de la especie',
                },
