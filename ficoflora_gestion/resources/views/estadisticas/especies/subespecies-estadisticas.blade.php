...
@section('titulo-seccion')
    Estadísticas de las subespeciess
@stop
...
@section('breadcrumbs')
    ...
    <li><a ><span>Subespecies</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Subespecies registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Subespecies más comunes</h4>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Subespecies registradas</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable" class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($subespecies as $subespecie)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('subespecie.mostrar',$subespecie['id'] )}}">{{$subespecie['nombre']}}</a></td>
                                <td class="acciones-row">{{$subespecie['especies']}}</td>
                            </tr>
