...
@section('titulo-seccion')
    Estadísticas de los Autoridades
@stop
...
@section('breadcrumbs')
    ...
    <li><a ><span>Autoridades</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Autoridades registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Autoridades con más especies</h4>

            <div id="autoridades-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Autoridades registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($autoridades as $autoridad)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('autor.mostrar',$autoridad['id'] )}}">{{$autoridad['nombre']}}</a></td>
                                <td class="acciones-row">{{$autoridad['especies']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var autoridades =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#autoridades-chart',
            data: {
                json:
                        autoridades
                ,
                ...
                type : 'bar',
                names: {
                    especies: 'Especies de la autoridad',
                },
