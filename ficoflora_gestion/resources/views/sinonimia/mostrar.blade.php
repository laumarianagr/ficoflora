                        ...
                        <tr>
                            ...
                            <td class="perfil">
                                ...
                                <a href="{{route('especie.mostrar', [$especie['id']])}}">
                                    ...
                                    @if(($especie['varietal'] != null) && ($especie['varietal'] != 0))
                                        <em>var. {{$especie['varietal']}}</em>
                                    @endif

                                    @if(($especie['forma'] != null) && ($especie['forma'] != 0))
                                        <em>f. {{$especie['forma']}}</em>
                                    @endif

                                    @if(($especie['subespecie'] != null) && ($especie['subespecie'] != 0))
                                        <em>f. {{$especie['subespecie']}}</em>
                                    @endif
