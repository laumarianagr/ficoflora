...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH','route'=> ['autor.actualizar', $autor['id']],   'id'=>'jv_autor', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title"> Editar Autoridad</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('autor', $autor['nombre'], ['id'=>'autor', 'class' => 'form-control typeahead preview', 'autocomplete' => 'off']) !!}
                    </div>
