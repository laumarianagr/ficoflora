...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['url' => 'autores',  'id'=>'jv_autor', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Nueva Autoridad</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('autor', null, ['id'=>'autor', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
...
@section('script_section')
    ...
    <script type='text/javascript' src='{{ asset('js/registros/crear_autor.js')}}'></script>

    <script type="text/javascript">
            var autores = <?php echo $autores; ?>;
