...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Subespecie</span></a></li>
@stop
...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH','route'=> ['subespecie.actualizar', $subespecie['id']],   'id'=>'jv_subespecie', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title"> Editar Subespecie</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class=" control-label" for="subespecie">Subespecie <span class="required">*</span></label>

                        {!! Form::text('subespecie', $subespecie['nombre'], ['id'=>'subespecie', 'class' => 'form-control typeahead preview', 'autocomplete' => 'off']) !!}
                    </div>
                </div>
            </div>
