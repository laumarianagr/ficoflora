...
@section('breadcrumbs')
    ...
    <li><a href="#"><span>Clase</span></a></li>
@stop
...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH', 'route' => ['clase.actualizar', $clase['id']],  'id'=>'jv_clase', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">


                <h2 class="panel-title">Editar Clase</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('clase', $clase['nombre'], ['id'=>'clase', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class=" control-label" for="phylum_select">Phylum <span class="required">*</span></label>
                        <div>
                            <div class="col-xs-6 col-sm-9 pl-none">

                                {!! Form::select('phylum', $phylums, $clase['phylum_id'], ['id'=> 'phylum','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
                            <div class="col-xs-4 col-sm-3 pt-xs">
                                <a class="text-md modal-basic modal-with-zoom-anim  get_typeahead-datos" href="#modal_nuevoPhylum" id="nuevo-phylum"><span class="fa fa-plus-circle va-middle text-xl " aria-hidden="true"></span> Nueva</a>
    ...
    {{--MODAL NUEVO ORDEN--}}
    @include('taxonomia.modales._modal-nuevo-phylum')
