...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['route'=> 'varietal.guardar',  'id'=>'jv_varietal', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title"> Nuevo Epíteto Varietal</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('varietal', null, ['id'=>'variedad', 'class' => 'form-control typeahead preview', 'autocomplete' => 'off']) !!}
                    </div>
