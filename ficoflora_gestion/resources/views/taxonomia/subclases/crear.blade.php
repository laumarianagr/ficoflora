...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['url' => 'subclases',  'id'=>'jv_subclase', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title">Nueva Subclase</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('subclase', null, ['id'=>'subclase', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
