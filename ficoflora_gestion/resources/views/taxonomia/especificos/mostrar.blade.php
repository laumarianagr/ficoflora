...
@section('titulo-seccion')
    Información del Epíteto Específico
@stop

@section('breadcrumbs')
    <li><a href="{{route('registros.index')}}"><span>Registros</span></a></li>
    <li><a href="#"><span>Epíteto Específicos</span></a></li>
                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    <span class="muted">Epíteto Específico:</span> <strong class="amount"><em>{{$especifico['nombre']}}</em></strong>
                            ...
                            @if($usuario->perfil_id <=3)
                                ...
                                <div class="summary-footer">
                                    <a class="" href="{{route('usuario.especificos')}}"><i class="fa fa-user pr-xs"></i>Mis específicos</a>

                                    @if($especifico['creador_id'] == $usuario->id || $usuario->perfil_id <=2)
                                    | <a href="{{route('especifico.editar', [$especifico['id']])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                    @endif
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class=" mb-md tabla-mostrar-datos ">
                        <h4 class="">Especies donde está presente el epíteto: </h4>
                    </div>
