...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH', 'route' => ['orden.actualizar', $orden['id']],  'id'=>'jv_taxonomia', 'class' => 'form  form-bordered']) !!}
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('orden', $orden['nombre'], ['id'=>'orden', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>

                    <div class="form-group col-md-12">
                        <div class="">
                            <div class="checkbox-custom checkbox-primary ">
                                {!! Form::checkbox('check', 1, $check, ['id' => 'check']) !!}
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <div class="col-xs-6 col-sm-9 pl-none">
                                {!! Form::select('subclase', $subclases, $orden['subclase_id'], ['id'=> 'subclase','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <div class="col-xs-6 col-sm-9 pl-none">
                                {!! Form::select('clase', $clases, $orden['clase_id'], ['id'=> 'clase', 'class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
...
//            $( "#check" ).prop("checked",true);
            ...
            if(check == true){
                selectClase.prop("disabled", true).val(null).trigger("change")
            }else{
                selectSubclase.prop("disabled", true).val(null).trigger("change")
            }
