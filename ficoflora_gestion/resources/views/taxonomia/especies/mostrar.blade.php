                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    ...
                                    <strong class="amount"><em>
                                        {{$especie['genero']}} {{$especie['especifico']}}

                                        @if($especie['varietal'] != null)
                                            var. {{$especie['varietal']}}
                                        @endif
                    ...
                    {{--<section class="panel tabla-mostrar-datos ">--}}
                        <div class="panel-body">
                            ...
                            <table class="table table-striped">
                                ...
                                @if($especie['subespecie'] != null)
                                    <tr><td><h5><b>Subespecie:</b></h5> <a class="text-muted" href="{{route('subespecie.mostrar', [$especie['subespecie_id']])}}">{{$especie['subespecie']}} </a> </td></tr>
                                @endif
