                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    <span class="muted">Phylum:</span> <strong class="amount"><em>{{$phylum['phylum']}}</em></strong>
                            ...
                            @if($usuario->perfil_id <=3)
                                <div class="summary-footer">
                                    <a class="" href="{{route('usuario.phylums')}}"><i class="fa fa-user pr-xs"></i>Mis phyla</a>

                                    @if($phylum['creador_id'] == $usuario->id || $usuario->perfil_id <=2)
                                        | <a href="{{route('phylum.editar', [$phylum['phylum_id']])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                    @endif
                                </div>
                            @endif
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($clases as $clase)
                            ...
                            <tr>
                                ...
                                <td class="perfil">
                                    <a href="{{route('clase.mostrar', [$clase->id])}}">
                                        <em>{{$clase->nombre}}</em>
                                    </a>
                                </td>
...
@section('script_section')
    ...
    <script type='text/javascript' src='{{ asset('js/registros/mis-registros/taxonomia/phylums-usuario.js')}}'></script>
