 ...
 * Edited by Yusneyi Carballo Barrera on 22/08/2017
 */
...
//género solo completa los formularios de typeahead
...
//console.log( taxonomia.genero);
    ...
    $('#especie.typeahead, #s-especie.typeahead').typeahead({
        ...
        //setSubespecie(suggestion.subespecie);
...
//---SUBESPECIE------------
    var subespecie = new Bloodhound({
        ...
        local: taxonomia.subespecie
    });

    $('#subespecie.typeahead, #s-subespecie.typeahead').typeahead({
        hint: false,
        highlight: true,
        minLength: 1
        ...
        displayKey: 'nombre',
        templates: {
            header: '<h5 class="type-header">Subespecies registradas</h5>'
        },
