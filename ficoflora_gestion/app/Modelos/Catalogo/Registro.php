...
class Registro extends Model
{
    ...
    {
        return $this->belongsToMany('App\Modelos\Sinonimias\Sinonimia', 'registro_sinonimia')->withTimestamps();
    }
    ...
    {
        return $this->belongsToMany('App\Modelos\Geografico\Ubicacion', 'registro_ubicacion')->withTimestamps();
    }
