...
class Especie extends Model {
    ...
    /**
     * Una especie PERTENECE a un especificos.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function especifico()
    {
        return $this->belongsTo('App\Modelos\Taxonomia\Especifico');

    }
    public function varietales()
    {
        return $this->belongsTo('App\Modelos\Taxonomia\Varietal');

    }
    public function formas()
    {
        return $this->belongsTo('App\Modelos\Taxonomia\Forma');

    }
    public function subespecies()
    {
        return $this->belongsTo('App\Modelos\Taxonomia\Subespecie');
    ...
    /**
     * Busca en la BDD si hay ESPECIES con un epíteto determinado.
     *
     * @param $query
     */

    public function scopeConEspecifico($query,$especifico_id)
    {
