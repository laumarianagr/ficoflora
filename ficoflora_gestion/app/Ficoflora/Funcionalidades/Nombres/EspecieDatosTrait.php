...
trait EspecieDatosTrait {
    ...
    public function especieDatos($mi_especie, $id, $taxo_superior)
    {
        ...
        if($mi_especie->subespecie_id != null){
            $subespecie = Subespecie::find($mi_especie->subespecie_id);
            $especie['subespecie'] = $subespecie->nombre;
            $especie['subespecie_id'] = $subespecie->id;
        }else{
    ...
    public function especieNombrePorIds($especie)
    {
        ...
        if($especie->subespecie_id != null){
            $nombre = $nombre .' subsp. '.$especie->subespecie_id;
        }
