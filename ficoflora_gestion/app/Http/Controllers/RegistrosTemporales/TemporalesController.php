...
class TemporalesController extends Controller
{
    ...
    public function index()
    {
        $temporales =  DB::table('temporales')
            ->select(DB::raw('id, genero, especifico, varietal, forma, subespecie, autor, referencia, referencia_tipo'))
            ->get();
...
//        dd($reportes);
    ...
    public function crear()
    {
        ...
        $taxonomia = array( 'phylum' => $phylum, 'clase' => $clase, 'subclase' => $subclase, 'orden' => $orden, 'familia' => $familia, 'genero' => $genero, 'especifico' => $especifico, 'varietal' => $varietal, 'forma' => $forma, 'subespecie' => $subespecie, 'autor' => $autor);
...
//        dd($request->all());
        ...
        switch($request->referencia){
            ...
            case 'T':
                ...
                break;
            case 'E':
                $referencia = $this->getObjetoEnlace($request);
                break;
            case 'C':
                $referencia = $this->getObjetoCatalogo($request);
                break;
        }
        ...
        if($request->especie_id != null){
            ...
            $especifico = $especie['especifico']; $varietal  = $especie['varietal']; $forma = $especie['forma'];  $subespecie = $especie['subespecie'];
            $autor  = $especie['autor'];
            ...
            $varietal  = $request->variedad; $forma =$request->forma;  $subespecie =$request->subespecie; $autor  = $request->autor;
        ...
        $temporal = new Temporal([
            ...
            'genero' => $genero, 'especifico'=>$especifico,'varietal' => $varietal, 'forma'=>$forma, 'subespecie'=>$subespecie, 'autor' => $autor,
