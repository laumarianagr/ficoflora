...
//Registros Usuario
   ...
   //Taxonómicos
    ...
    Route::get('usuario/registros/subespecies', ['as' => 'usuario.subespecies','uses' => 'Cuentas\UsuarioController@subespecies']);
    ...
    Route::get('usuario/registros/catalogos', ['as' => 'usuario.catalogos','uses' => 'Cuentas\UsuarioController@catalogos']);
...
Route::get('listados', ['as' => 'listados.index', 'uses' => 'Listados\ListadosTaxonomicosController@index']);
   ...
   //Taxonómicos
    ...
    Route::get('listado/subespecies', ['as' => 'listado.subespecies','uses' => 'Listados\ListadosTaxonomicosController@subespecies']);
    ...
    Route::get('listado/catalogos', ['as' => 'listado.catalogos','uses' => 'Listados\ListadosBibliograficosController@catalogos']);
...
//---------------------------
    ...
    Route::get('estadisticas/subespecies', ['as' => 'estadisticas.subespecies', 'uses' => 'Estadisticas\EstadisticasEspeciesController@subespecies']);
    ...
    Route::get('estadisticas/enlaces', ['as' => 'estadisticas.enlaces', 'uses' => 'Estadisticas\EstadisticasBibliograficasController@enlaces']);
    Route::get('estadisticas/catalogos', ['as' => 'estadisticas.catalogos', 'uses' => 'Estadisticas\EstadisticasBibliograficasController@catalogos']);
...
//Subespecie
Route::get('subespecies/crear', ['as' => 'subespecie.crear', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@crear']);
Route::post('subespecies', ['as' => 'subespecie.guardar', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@guardar']);
Route::get('subespecies/{id}', ['as' => 'subespecie.mostrar', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@mostrar']);
Route::get('subespecies/{id}/editar', ['as' => 'subespecie.editar', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@editar']);
Route::patch('subespecies/{id}/', ['as' => 'subespecie.actualizar', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@actualizar']);
Route::delete('subespecies/{id}', ['as' => 'subespecie.eliminar', 'uses' => 'RegistrosVenezuela\Taxonomia\Epitetos\SubespeciesController@eliminar']);
...
//Catálogos
//Route::get('referencias/catalogos/crear', ['as' => 'catalogo.crear', 'uses' => 'Bibliografia\Referencias\CatalogosController@crear']);
Route::post('referencias/catalogos', ['as' => 'catalogo.guardar', 'uses' => 'Bibliografia\Referencias\CatalogosController@guardar']);
Route::get('referencias/catalogos/{id}', ['as' => 'catalogo.mostrar', 'uses' => 'Bibliografia\Referencias\CatalogosController@mostrar']);
Route::get('referencias/catalogos/{id}/editar', ['as' => 'catalogo.editar', 'uses' => 'Bibliografia\Referencias\CatalogosController@editar']);
Route::patch('referencias/catalogos/{id}/', ['as' => 'catalogo.actualizar', 'uses' => 'Bibliografia\Referencias\CatalogosController@actualizar']);
Route::delete('referencias/catalogos/{id}', ['as' => 'catalogo.eliminar', 'uses' => 'Bibliografia\Referencias\CatalogosController@eliminar']);
...
Route::get('buscar/subespecies/{query}', ['as' => 'buscar.subespecies', 'uses' => 'Buscar\BusquedasController@getSubespecies']);
...
Route::get('buscar/catalogos/autores/{query}', ['as' => 'buscar.catalogos.autores', 'uses' => 'Buscar\BusquedasController@getCatalogosAutores']);
Route::get('buscar/catalogos/titulos/{query}', ['as' => 'buscar.catalogos.titulos', 'uses' => 'Buscar\BusquedasController@getCatalogosTitulos']);
Route::get('buscar/enlaces/autores/{query}', ['as' => 'buscar.enlaces.autores', 'uses' => 'Buscar\BusquedasController@getEnlacesAutores']);
Route::get('buscar/enlaces/titulos/{query}', ['as' => 'buscar.enlaces.titulos', 'uses' => 'Buscar\BusquedasController@getEnlacesTitulos']);
