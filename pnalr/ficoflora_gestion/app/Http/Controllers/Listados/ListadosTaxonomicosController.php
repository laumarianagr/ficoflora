...
class ListadosTaxonomicosController extends Controller
{
    ...
    public function especies()
    {
        ...
        $especies = DB::table('especies')
            ...
            ->select(DB::raw('especies.id, especies.catalogo, epitetos_especificos.nombre as especifico, epitetos_varietales.nombre as varietal, epitetos_formas.nombre as forma, generos.nombre as genero, autores.nombre as autor'))
