...
//        dd( $registros);
    ...
    public function editar($id)
    {
        ...
        $familias = Familia::lists('nombre', 'id');
//        $generos = Genero::where('familia_id', '!=', -1)->lists('nombre', 'id');
...
//        dd($especie);
        ...
        $taxonomia = array( 'genero' => $genero_type, 'especifico' => $especifico_type, 'varietal' => $varietal_type, 'forma' => $forma_type, 'autor' => $autores);
        $taxonomia = json_encode($taxonomia);
...
//        dd($especie);
        ...
        return view('taxonomia.especies.editar', compact('taxonomia', 'familias', 'autores', 'especie', 'generos', 'especificos', 'varietales', 'formas'));
    }
...
//        dd($especie);
    ...
    {
        $log_g =  $log_e =  $log_v =  $log_f =  $log_a = false;
        $usuario = Auth::user();
