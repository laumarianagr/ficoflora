...
//            ->get();
    ...
    public function crear()
    {
        ...
        $taxonomia = array('phylum' =>$phylum, 'clase' => $clase, 'subclase' => $subclase, 'orden' => $orden, 'familia' => $familia, 'genero' => $genero, 'especifico' => $especifico, 'varietal' => $varietal, 'forma' => $forma, 'autor' => $autor, 'cita_autor' => $cita_autor);
...
//        dd($autor);
        ...
        $registro = new Registro(['id'=> $especie->id,'phylum' => $phylum->nombre, 'clase' => $clase->nombre, 'subclase' => $subclase, 'orden' => $orden->nombre, 'familia' => $familia->nombre, 'genero' => $genero->nombre,'especifico' => $especie->especifico, 'varietal'=> $especie->varietal, 'forma' => $especie->forma, 'autor' => $autor->nombre]);
...
//        dd($registro);
    ...
    public function mostrar($id)
    {
        ...
        $registro = new Registro(['id'=> $especie->id,'phylum' => $phylum->nombre, 'clase' => $clase->nombre, 'subclase' => $subclase, 'orden' => $orden->nombre, 'familia' => $familia->nombre, 'genero' => $genero->nombre,'especifico' => $especifico->nombre, 'varietal'=> $varietal, 'forma' => $forma, 'autor' => $autor->nombre]);
