...
class EnlacesDatos {
    ...
    public function camposObligatorios($datos)
    {
        ...
        if(($datos['cita'] == null ) || ($datos['direccion_web'] == null )
            || ($datos['dia_consulta'] == null ) || ($datos['mes_consulta'] == null )
            ||  ($datos['ano_consulta'] == null ) )
        {
...
//        Pasando del formato de los archivos al de los formularios para reutilizar el código del procesamieto de referencias
        $registro = new EnlaceRegistro($dato, 'archivo', 2);
