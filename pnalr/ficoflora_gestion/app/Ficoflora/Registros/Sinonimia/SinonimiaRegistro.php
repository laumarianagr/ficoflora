...
class SinonimiaRegistro {
    ...
    public function nuevaSinonimia()
    {
        ...
        $registro = $this->getSinonimia($genero_id, $especifico_id, $varietal_id, $forma_id, $autor_id);
     ...
     */
    public function getSinonimia($genero_id, $especifico_id, $varietal_id, $forma_id, $autor_id)
    {
        $obj_sinonimia = Sinonimia::where('genero_id', $genero_id)->conEspecificoId($especifico_id)->conVarietalId($varietal_id)->conFormaId($forma_id)->conAutorId($autor_id)->first();

        if($obj_sinonimia == null){
            $this->existe= false;
            return new Sinonimia(['genero_id' => $genero_id, 'especifico_id' => $especifico_id, 'varietal_id' => $varietal_id, 'forma_id' => $forma_id, 'autor_id' => $autor_id, 'creador_id' => $this->creador_id]);
        }
