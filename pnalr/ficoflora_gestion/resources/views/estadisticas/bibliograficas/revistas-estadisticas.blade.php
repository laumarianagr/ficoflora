...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Revistas registradas</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Revistas con más registros</h4>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading p-xs">
                    ...
                    <h5 class="name pl-md"> Revistas registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable_geografica"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        @foreach($revistas as $revista)
                            ...
                            <tr>
                                ...
                                <td class="perfil">{{$revista['titulo']}}</td>
