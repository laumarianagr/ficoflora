...
@section('titulo-seccion')
    Estadísticas de los Epítetos de forma
@stop
...
@section('breadcrumbs')
    ...
    <li><a ><span>Epítetos de forma</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Epítetos de forma registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Epítetos de forma con más especies</h4>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading  p-xs">
                    ...
                    <h5 class="name pl-md"> Epíteto de Forma registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="numeros">#</th>
                            <th class="perfil-col">Nombre del Epíteto de Forma</th>
                        ...
                        @foreach($formas as $forma)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('forma.mostrar',$forma['id'] )}}">{{$forma['nombre']}}</a></td>
                                <td class="acciones-row">{{$forma['especies']}}</td>
