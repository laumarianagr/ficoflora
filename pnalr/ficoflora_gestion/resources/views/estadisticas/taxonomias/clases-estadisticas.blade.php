...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Clases registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Clases con más subclases</h4>

            <div id="clases-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading bg-dark p-xs">
                    ...
                    <h5 class="name pl-md"> Clases registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <th class="numeros">#</th>
                            <th class="perfil-col">Nombre de la Clases</th>
                            <th class="perfil-col" style="width:120px;">N° de subclases</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($clases as $clase)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('clase.mostrar',$clase['id'] )}}">{{$clase['nombre']}}</a></td>
                                <td class="acciones-row">{{$clase['subclases']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var clases =<?php echo json_encode($mas_usados); ?>;
        ...
        var chart = c3.generate({
            ...
            data: {
                ...
                type : 'bar',
                names: {
                    subclases: 'Número de subclases reportadas',
                },
