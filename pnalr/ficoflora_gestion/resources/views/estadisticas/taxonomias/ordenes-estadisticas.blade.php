...
@section('titulo-seccion')
    Estadísticas de los Órdenes
@stop

@section('breadcrumbs')
    <li><a href="{{route('estadisticas.index')}}"><span>Estadísticas</span></a></li>
    <li><a href="{{route('estadisticas.taxonomias')}}" ><span>Taxonómicas</span></a></li>
    <li><a ><span>Órdenes</span></a></li>
...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Órdenes registrados</h3>
    ...
    <div class="row">
        <div class="col-xs-12 mt-lg">
            ...
            <h4 class="text-dark mt-none mb-lg">Órdenes con más familias</h4>

            <div id="ordenes-chart"></div>
        ...
        <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
            <section class="panel">
                <header class="panel-heading bg-dark p-xs">
                    ...
                    <h5 class="name pl-md"> Órdenes registrados</h5>
                </header>
                <div class="panel-body">
                    ...
                    <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <th class="perfil-col" style="width:120px;">N° de familias</th>
                        </tr>
                        </thead>
                        ...
                        @foreach($ordenes as $orden)
                            ...
                            <tr>
                                <td></td>
                                <td class="perfil"><a href="{{route('orden.mostrar',$orden['id'] )}}">{{$orden['nombre']}}</a></td>
                                <td class="acciones-row">{{$orden['familias']}}</td>
...
@section('script_section')
    ...
    <script>
        ...
        var ordenes =<?php echo json_encode($mas_usados); ?>;

        var chart = c3.generate({
            bindto: '#ordenes-chart',
            data: {
                json:
                        ordenes
                ,
                ...
                type : 'bar',
                names: {
                    familias: 'Número de familias reportadas',
                },
