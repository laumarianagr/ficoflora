...
@section('content')
                    ...
                    <div class="widget-summary ">
                        ...
                        <div class="widget-summary-col">
                            <div class="summary">
                                ...
                                <h3 class="text-dark mt-sm mb-none">Géneros registrados</h3>
 ...
 <div class="row">
     <div class="col-xs-12 mt-lg">
         ...
         <h4 class="text-dark mt-none mb-lg">Géneros con más especies</h4>
     ...
     <div class="col-md-12 col-xl-10 col-xl-push-1 mt-xlg">
         <section class="panel">
             <header class="panel-heading bg-dark p-xs">
                 ...
                 <h5 class="name pl-md"> Géneros registrados</h5>
             </header>
             <div class="panel-body">
                 ...
                 <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                     ...
                     @foreach($generos as $genero)
                         ...
                         <tr>
                             <td></td>
                             <td class="perfil"><a href="{{route('genero.mostrar',$genero['id'] )}}">{{$genero['nombre']}}</a></td>
                             <td class="acciones-row">{{$genero['especies']}}</td>
        ...
        var generos =<?php echo json_encode($mas_usados); ?>;
            ...
            var chart = c3.generate({
                ...
                data: {
                    ...
                    type : 'bar',
                    names: {
                        especies: 'Especies con el género',
                    },
