                ...
                <div class="row" >
                    <div class="col-xs-12 col-md-8 col-md-offset-2" >
                        ...
                        <section class="panel form-wizard mb-xs" id="ref_trabajos">
                            ...
                            {!! Form::open(['method'=> 'PATCH', 'route' => ['trabajo.actualizar', $trabajo->id], 'id'=>'referencia_trabajo', 'class' => 'form form-bordered form_ref']) !!}
                            ...
                            <div class="panel-body">
                                <div class="wizard-progress">
                                    ...
                                    <ul class="wizard-steps">
                                        ...
                                        <li>
                                            <a href="#trabajo_paso_3" data-toggle="tab"><span>3</span>Complentaria</a>
                                        </li>
                                    </ul>
                                </div>
