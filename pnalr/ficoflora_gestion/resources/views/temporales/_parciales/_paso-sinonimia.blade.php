            ...
            <div class="panel panel-accordion ">
                ...
                <div id="sinonimia_busqueda" class="accordion-body collapse">
                    <div class="panel-body">
                        ...
                        {!! Form::open(['route' => 'sinonimia.mostrar',  'id'=>'jv_sinonimia_select', 'class' => 'form  form-bordered']) !!}
            ...
            <div class="panel panel-accordion ">
                ...
                <div id="sinonimia_crear" class="accordion-body collapse in">
                    <div class="panel-body">
                        ...
                        {!! Form::open(['route' => 'sinonimia.mostrar',  'id'=>'jv_sinonimia-temporal', 'class' => 'form  form-bordered']) !!}
                            ...
                            <footer class="panel-footer">
                                <div class="form-group">
                                    <div class="col-sm-3 col-sm-offset-3 ">
                                        {!! Form::submit('Agregar', ['id'=>'crear_sinonimia', 'class' => 'btn btn-primary form-control']) !!}
                                    </div>
