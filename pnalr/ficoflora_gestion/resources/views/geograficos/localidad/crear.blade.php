...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['route' => ['localidad.guardar'],  'id'=>'jv_localidad', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">


                <h2 class="panel-title">Nueva Localidad</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('localidad', null, ['id'=>'localidad', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <label class=" control-label" for="orden_select">Entidad Federal <span class="required">*</span></label>
                        <div>
                            <div class="col-xs-12 col-sm-12 pl-none">
                                {!! Form::select('entidad', $entidades, null, ['id'=> 'entidad','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
                        </div>
                    </div>
