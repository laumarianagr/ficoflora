...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH', 'route' => ['lugar.actualizar', $lugar['id']],  'id'=>'jv_lugar', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">


                <h2 class="panel-title">Editar Lugar</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('lugar', $lugar['nombre'], ['id'=>'lugar', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('latitud', $lugar['latitud'], ['id'=>'latitud', 'class' => 'form-control', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('longitud', $lugar['longitud'], ['id'=>'longitud', 'class' => 'form-control typeahead', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <div class="col-xs-12 col-sm-12 pl-none">
                                {!! Form::select('localidad', $localidades, $lugar['localidad_id'], ['id'=> 'localidad','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
                        </div>
                    </div>
