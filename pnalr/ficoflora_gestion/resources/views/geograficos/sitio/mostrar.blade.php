                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    <span class="muted">sitio: </span><strong class="amount">{{$ubicacion['sitio']}}</strong>
                            ...
                            @if($ubicacion['creador_id'] == $usuario->id || $usuario->perfil_id <=2)
                                ...
                                <div class="summary-footer">
                                    <a href="{{route('sitio.editar', [$ubicacion['sitio_id']])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                </div>
                            @endif
            ...
            <div id="collapse2One" class="accordion-body collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        ...
                        <tr><td><h5><b>Sitio:</b></h5> <a class="text-muted" href="{{route('sitio.mostrar', [$ubicacion['sitio_id']])}}">{{$ubicacion['sitio']}} </a></td></tr>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class=" mb-md tabla-mostrar-datos ">
                        <h4 class="">Especies  reportadas en el Sitio: </h4>
                    </div>
