    ...
    <div class="col-md-12 col-xl-10 col-xl-push-1">
        <section class="panel">
            <header class="panel-heading p-xs">
                <h5 class="name" ><i class="fa fa-list-ol pr-xs pl-sm"></i> Sitios registrados por el usuario</h5>
            </header>
            <div class="panel-body">

                <div class="row">
                    <div class="col-sm-8">
                        <h5 class="mt-xs mb-xs">Número de sitios: <b>{{$total}}</b></h5>
                    </div>
                    <div class="col-sm-4 ">
                        <a class="btn btn-default pull-right" href="{{route('sitio.crear')}}" id="crear-row" data-toggle="tooltip" title="Nuevo" ><i class="fa fa-plus text-primary"></i> Nuevo Sitio</a>
                    </div>
                </div>
                ...
                <table id="datatable"  class="table table-hover table-striped table-bordered listas-resultados" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <th class="perfil-col">Nombre del Sitio</th>
                        <th class="perfil-col">Ubicado en el Lugar</th>
                    ...
                    @foreach($sitios as $sitio)
                        ...
                        <tr>
                            <td></td>
                            <td class="" data-type="text" >{{$sitio->id}}</td>
                            <td class="" data-type="text" ><a href="{{route ('sitio.mostrar' ,$sitio->id )}}" >{{$sitio->nombre}}</a></td>
                            <td class="" data-type="text" >{{$sitio->lugar}}</td>

                            <td class="acciones-row">
                                <a href="{{route ('sitio.editar' ,$sitio->id )}}" class="editar-row" data-toggle="tooltip" title="Editar" ><i class="fa fa-pencil"></i></a>
                                ...
                                <a href="{{route ('sitio.mostrar' ,$sitio->id )}}"  data-toggle="tooltip" title="Información" ><i class="fa fa-info-circle"></i></a>
                            </td>
