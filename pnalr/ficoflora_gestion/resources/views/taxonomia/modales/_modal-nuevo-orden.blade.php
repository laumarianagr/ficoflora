<div id="modal_nuevoOrden" class="zoom-anim-dialog modal-block mfp-hide">
    <section class="panel">
        <header class="panel-heading">
            <h2 class="panel-title">Nuevo Árbol Taxonómico</h2>
        </header>

        {!! Form::open(['route'=> ['taxonomia.guardar', 'orden'], 'id'=>'jv_taxonomia', 'class' => 'form form-horizontal form-bordered jvalidate jv_taxonomia' ]) !!}
