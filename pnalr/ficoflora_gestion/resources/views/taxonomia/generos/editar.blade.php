...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH', 'route' => ['genero.actualizar', $genero['id']],  'id'=>'jv_genero', 'class' => 'form  form-bordered']) !!}
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('genero', $genero['nombre'], ['id'=>'genero', 'class' => 'form-control typeahead preview to-select', 'autocomplete' => 'off']) !!}
                    </div>
                    ...
                    <div class="form-group col-md-12">
                        ...
                        <div>
                            <div class="col-xs-6 col-sm-9 pl-none">
                                ...
                                {!! Form::select('familia', $familias, $genero['familia_id'], ['id'=> 'familia','class' => 'form-control select', 'style'=>'width: 100%']) !!}
                            </div>
