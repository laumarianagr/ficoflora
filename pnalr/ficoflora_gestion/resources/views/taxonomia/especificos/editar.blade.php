...
@section('content')
    ...
    <div class="col-lg-8 col-lg-push-2 col-xl-6 col-xl-push-3">
        {!! Form::open(['method'=> 'PATCH','route'=> ['especifico.actualizar', $especifico['id']],   'id'=>'jv_especifico', 'class' => 'form  form-bordered']) !!}

        <section class="panel">
            <header class="panel-heading">
                <h2 class="panel-title"> Editar Epíteto Específico</h2>
            ...
            <div class="panel-body">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        {!! Form::text('especifico', $especifico['nombre'], ['id'=>'especie', 'class' => 'form-control typeahead preview', 'autocomplete' => 'off']) !!}
                    </div>
