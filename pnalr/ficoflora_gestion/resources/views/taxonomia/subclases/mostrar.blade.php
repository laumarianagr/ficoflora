                    ...
                    <div class="widget-summary">
                        ...
                        <div class="widget-summary-col">
                            ...
                            <div class="summary mb-sm">
                                ...
                                <div class="info">
                                    <span class="muted">Subclase:</span> <strong class="amount"><em>{{$subclase['subclase']}}</em></strong>
                            ...
                            @if($usuario->perfil_id <=3)
                                ...
                                <div class="summary-footer">
                                    <a class="" href="{{route('usuario.subclases')}}"><i class="fa fa-user pr-xs"></i>Mis subclases</a>
                                    @if($subclase['creador_id'] == $usuario->id || $usuario->perfil_id <=2)
                                    | <a href="{{route('subclase.editar', [$subclase['subclase_id']])}}"><i class="fa fa-pencil pr-xs"></i>Editar </a>
                                    @endif
                                </div>
                            @endif
            ...
            <div id="collapse2One" class="accordion-body collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    ...
                    <table class="table table-striped">
                        <tr><td><h5><b>Phylum::</b></h5> <a class="text-muted" href="{{route('phylum.mostrar', [$subclase['phylum_id']])}}">{{$subclase['phylum']}} </a></td></tr>
                        <tr><td><h5><b>Clase:</b></h5> <a class="text-muted" href="{{route('clase.mostrar', [$subclase['clase_id']])}}">{{$subclase['clase']}} </a></td></tr>
            ...
            <div class="panel">
                <div class="panel-body">
                    ...
                    <div class=" mb-md tabla-mostrar-datos ">
                        <h4 class="">Órdenes de la Subclase: </h4>
                    </div>
...
@section('script_section')
    ...
    <script type='text/javascript' src='{{ asset('js/registros/mis-registros/taxonomia/subclases-usuario.js')}}'></script>
