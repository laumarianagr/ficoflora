(function (factory) {
  ...
  CropAvatar.prototype = {
    ...
    submit: function () {
      if (!this.$avatarSrc.val() && !this.$avatarInput.val() && !this.$avatarId.val()) {
        return false;
      }
...
this.$avatarSave.attr("disabled", false);
    ...
    alert: function (msg) {
      var $alert = [
            '<div class="alert alert-danger avater-alert" id="alert">',
     ...
     var close = document.getElementById("alert");  
       ...
       var padre = close.parentNode;
     padre.removeChild(close);
