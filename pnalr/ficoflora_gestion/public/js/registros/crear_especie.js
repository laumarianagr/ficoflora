...
$(document).ready(function() {
    ...
    $("#familia.select").on('change', function (e) {
        getTaxonomia($(this).val()); // Hace la llamada para buscar en la BD el arbol taxonomico
    });


    //Trae los datos para llenar el arbol taxonomico de Resultado al seleccionar una familia de la lista
